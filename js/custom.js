...
(function () {
    ...
    var OnePageNav = function () {
        var navToggler = $('.eco-js-nav-toggle');
        $(".smoothscroll[href^='#'], #eco-navbar ul li a[href^='#']").on('click', function (e) {
            e.preventDefault();
            var hash = this.hash;
            $('html, body').animate({
        ...
        $("#eco-navbar ul li a[href^='#']").on('click', function (e) {
    ...
    $('.eco-js-nav-toggle').on('click', function (e) {
        var $this = $(this);
        e.preventDefault();
        if ($('body').hasClass('menu-open')) {
            $this.removeClass('active');
            $('.eco-menu .eco-menu-inner > ul > li').each(function (i) {
                var that = $(this);
                setTimeout(function () {
            ...
            setTimeout(function () {
                $('.eco-menu').removeClass('eco-menu-show');
            }, 800);
            $('body').removeClass('menu-open');
        }
        else {
            $('.eco-menu').addClass('eco-menu-show');
    ...
    $('.eco-menu .dropdown').hover(function () {
        var $this = $(this);
        $this.addClass('show');
    ...
    if ($('.js-cursor').length > 0) {
        ...
        $('a, h1, h2, h3, h4, h5, h6').hover(function () {
            $('.cursor').toggleClass('dark');
        });
        $('p').hover(function () {
